...
ax1 = plt.plot()
plt.plot(batch_size_record, train_acc_record, linestyle= '-', color= 'blue', label= 'train_acc')
plt.plot(batch_size_record, test_acc_record, linestyle= '--', color= 'blue', label= 'test_acc')
plt.xlabel('batch size')
